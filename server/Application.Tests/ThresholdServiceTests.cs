...
public class ThresholdServiceTests
{
    ...
    [TestCase("temperature", 10, 18, 25, ThresholdStates.CriticalLow)]     // under alle grænser
    [TestCase("temperature", 17, 18, 25, ThresholdStates.WarningLow)]      // lige under goodMin
    [TestCase("temperature", 18, 18, 25, ThresholdStates.Good)]            // på goodMin
    [TestCase("temperature", 22, 18, 25, ThresholdStates.Good)]            // indenfor good range
    [TestCase("temperature", 26, 18, 25, ThresholdStates.WarningHigh)]     // lige over goodMax
    [TestCase("temperature", 35, 18, 25, ThresholdStates.CriticalHigh)]    // langt over goodMax
